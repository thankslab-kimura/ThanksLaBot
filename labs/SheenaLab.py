...
def generatedTitle():
    ...
    kanji_file_name = 'labs/data/public/sheena/kanji.csv'
    katakana_file_name = 'labs/data/public/sheena/katakana.csv'

    if (os.path.exists(kanji_file_name) and os.path.exists(katakana_file_name)):

        kanji_data = pd.read_csv(kanji_file_name, encoding='utf-8')
        katakana_data = pd.read_csv(katakana_file_name, encoding='utf-8')
